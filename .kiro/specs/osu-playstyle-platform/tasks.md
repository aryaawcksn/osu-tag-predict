...
- [ ] 5. Implementasi osu! OAuth
  - [ ] 5.1 Buat `backend/auth.py` dengan OAuth flow handler
  ...
  - [ ] 5.2 Buat session middleware dan dependency get_current_user
    ...
    - _Requirements: 2.4_
  - [ ] 5.3 Implementasi token refresh logic
    - Sebelum osu! API call, cek expires_at; jika expired, refresh otomatis dan update DB
    - _Requirements: 2.6_
  - [ ] 5.4 Wire auth router ke main.py dan update lifespan untuk init DB connection
    - _Requirements: 2.1, 2.2, 2.3, 2.5, 2.6_
  - [ ]* 5.5 Write property test untuk OAuth session lifecycle
    - **Property 4: OAuth session lifecycle**
    - **Validates: Requirements 2.2, 2.5**

- [ ] 6. Frontend: NavBar, QueueBar, dan auth flow
  - [ ] 6.1 Tambah tipe QueueState, QueueJob, CurrentUser, DominantPlaystyle ke `frontend/src/types.ts`
    - _Requirements: 1.1, 1.6, 2.4_
  - [ ] 6.2 Update `frontend/src/api.ts` untuk queue-aware endpoints
  ...
  - [ ] 6.3 Buat `frontend/src/components/NavBar.tsx`
  ...
  - [ ] 6.4 Buat `frontend/src/components/QueueBar.tsx`
  ...
  - [ ] 6.5 Update App.tsx untuk integrasi NavBar, QueueBar, dan queue-aware submission
...
- [ ] 7. Implementasi AnalysisService
  - [ ] 7.1 Buat `backend/analysis.py`
  ...
  - [ ] 7.2 Buat endpoint GET /analysis/playstyle?source=top|recent di main.py
...
- [ ] 8. Implementasi RecommendationService
  - [ ] 8.1 Buat `backend/recommendation.py`
  ...
  - [ ] 8.2 Tambah endpoint GET /recommend dan POST /admin/beatmap di main.py
...
- [ ] 9. Frontend: AnalysisPanel dan RecommendationList
  - [ ] 9.1 Buat `frontend/src/components/AnalysisPanel.tsx`
  ...
  - [ ] 9.2 Buat `frontend/src/components/RecommendationList.tsx`
